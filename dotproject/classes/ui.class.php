 ...
 */
	function loadJS() {
		...
		echo ('<script type="text/javascript" src="' . $base . 'lib/mootools-1.2.4-core-yc.js"></script>'
		      . "\n");
		echo ('<script type="text/javascript" src="' . $base . 'lib/mootools-1.2.4.4-more.js"></script>'
		      . "\n");

		echo ('<script type="text/javascript">
                          window.addEvent(\'domready\', function(){
                              var tips = new Tips($$(\'.tips[title]\'), {
                                  text: function() { return \'<span class="title">' . $AppUI->_('Description'). '</span>\'}
                              });
                          });
                       </script>');
